...
/**
 * Ham in ra so nguyen to dau tien
 * @param arr Mang
 */
function SNTDauTien(arr: number[]): void {
...
/**
 * Ham chuc nang nhap so luong phan tu, goi ham nhap mang, ham tinh in ra so nguyen to dau tien
 */
function main(): void {
